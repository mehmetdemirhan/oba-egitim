...
import OgrenmeSeviyesi from "./OgrenmeSeviyesi";
...
const GORUNUMLER = [
  ...
  { key: "ogrenme", ad: "Öğrenme Seviyesi", ikon: Brain },
];
...
export default function AiYonetimKokpiti({ apiBase, user, onNavigate, baslangicGorunum }) {
  ...
  const detayBilesen = () => {
    switch (gorunum) {
      ...
      case "ogrenme": return <OgrenmeSeviyesi apiBase={apiBase} />;
      default: return null;
    }
  };
