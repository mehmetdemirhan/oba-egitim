...
_SISTEM_PROMPT = (
    ...
    "- GEÇERLİ ROLLER YALNIZ: UserRole.ADMIN, UserRole.COORDINATOR, UserRole.TEACHER, UserRole.STUDENT, "
    "UserRole.PARENT. Türkçe/uydurma sabit (UserRole.OGRENCI, VELI, OGRETMEN vb.) YOKTUR — kullanırsan "
    "modül import'ta AttributeError verir ve kurulum reddedilir. Öğrenci=STUDENT, veli=PARENT, öğretmen=TEACHER.\n"
